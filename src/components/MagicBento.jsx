...
const MagicBento = ({
  ...
  // Debug log to detect any object values being incorrectly passed into JSX
  // (temporary - will remove once the issue is identified)
  // eslint-disable-next-line no-console
  console.log('MagicBento init', {
    enableSpotlight,
    enableBorderGlow,
    disableAnimations,
